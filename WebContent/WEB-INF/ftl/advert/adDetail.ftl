			...
			<div id="content">
				...
				<article>
					...
					<div class="a-meta a-meta-left">
						<i class="fa fa-user"></i> Author | <i class="fa fa-calendar"></i> 20 Dec 2013 | <i class="fa fa-comment"></i> 6
					</div>
					<div class="article-comments">
						<h3 class="title"><i class="fa fa-comments"></i> Comments</h3>
						<ul>
							<li>
			...
			<nav id="menu">
				<ul>
					...
					<li class="Selected">
						...
						<ul>
							<li class="Selected"><a href="blog-single-post.html"><i class="fa fa-pencil-square-o"></i>First Post</a></li>
							<li>
